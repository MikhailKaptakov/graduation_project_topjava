...
public class VoteTestData {
    ...
    public static final Vote actualVote1UserRestaurant2 = new Vote(UserTestData.user, RestaurantTestData.actualRestaurant);
    ...
    public static final Vote actualVote1AdminRestaurant2 = new Vote(UserTestData.admin, RestaurantTestData.actualRestaurant);
    ...
    static {
        ...
        actualVote1UserRestaurant2.setId(FIRST_VOTE_ID + 2);
        ...
        actualVote1AdminRestaurant2.setId(FIRST_VOTE_ID + 6);
        vote2AdminRestaurant2.setId(FIRST_VOTE_ID + 7);
        vote2AdminRestaurant2.setVoteDate(LocalDate.of(2000,10,15));
    }

    public static final List<Vote> actualRestaurant2Votes = List.of(actualVote1UserRestaurant2, actualVote1AdminRestaurant2);
}
